import { r as registerInstance, h, H as Host, i as getElement, e as createEvent, f as readTask, j as forceUpdate, c as writeTask } from './index-8fc7a46a.js';
import { b as getIonMode, c as config, a as isPlatform } from './ionic-global-e0b8d325.js';
import { c as createColorClasses, h as hostContext } from './theme-ff3fc52f.js';
import { k as clamp, c as componentOnReady, i as inheritAttributes } from './helpers-58861e84.js';
import { g as getTimeGivenProgression } from './cubic-bezier-eea9a7a9.js';
import { a as attachComponent, d as detachComponent } from './framework-delegate-3f86234e.js';
import { t as transition } from './index-489dd145.js';
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!config.getBoolean('_testing')) {
          import('./tap-click-6f1ea101.js').then(module => module.startTapClick(config));
        }
        if (config.getBoolean('statusTap', isHybrid)) {
          import('./status-tap-250fb904.js').then(module => module.startStatusTap());
        }
        if (config.getBoolean('inputShims', needInputShims())) {
          import('./input-shims-0a16b204.js').then(module => module.startInputShims(config));
        }
        ...
        import('./focus-visible-ed0c99b3.js').then(module => this.focusVisible = module.startFocusVisible());
      });
    }
  }
  /**
...
const RouterOutlet = class {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await import('./swipe-back-b23c1a91.js')).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
      if (this.ani) {
        this.ani.onFinish(() => {
          this.gestureOrAnimationInProgress = false;
          if (this.swipeHandler) {
