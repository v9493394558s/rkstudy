    ...
    return (h("div", { class: "datetime-footer" },
      h("div", { class: "datetime-buttons" },
        h("div", { class: {
          ...
          h("slot", { name: "buttons" },
            h("ion-buttons", null,
              h("ion-button", { color: this.color, onClick: () => this.cancel(true) }, this.cancelText),
              h("div", null,
                this.showClearButton && h("ion-button", { color: this.color, onClick: () => clearButtonClick() }, this.clearText),
                h("ion-button", { color: this.color, onClick: () => this.confirm(true) }, this.doneText))))))));
  }
  renderYearView() {
