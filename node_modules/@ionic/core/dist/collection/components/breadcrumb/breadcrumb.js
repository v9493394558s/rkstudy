...
export class Breadcrumb {
  ...
  render() {
    ...
    return (h(Host, { onClick: (ev) => openURL(href, ev, routerDirection, routerAnimation), "aria-disabled": disabled ? 'true' : null, class: createColorClasses(color, {
      ...
      h(TagType, Object.assign({}, attrs, { class: "breadcrumb-native", part: "native", disabled: disabled, onFocus: this.onFocus, onBlur: this.onBlur }, inheritedAttributes),
        h("slot", { name: "start" }),
        h("slot", null),
        h("slot", { name: "end" })),
      showCollapsedIndicator &&
        h("button", { part: "collapsed-indicator", onClick: () => this.collapsedIndicatorClick(), ref: collapsedEl => this.collapsedRef = collapsedEl, class: {
          ...
          h("ion-icon", { icon: ellipsisHorizontal, lazy: false })),
      showSeparator &&
        h("span", { class: "breadcrumb-separator", part: "separator" },
          h("slot", { name: "separator" }, mode === 'ios'
