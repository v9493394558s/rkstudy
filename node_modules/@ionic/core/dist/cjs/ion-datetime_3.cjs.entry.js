...
const index$1 = require('./index-6b13c1ba.js');
const ionicGlobal = require('./ionic-global-729aef21.js');
const focusVisible = require('./focus-visible-13950869.js');
const helpers = require('./helpers-27851897.js');
const theme = require('./theme-30b7a575.js');
const overlays = require('./overlays-42d3ac7e.js');
const animation = require('./animation-ddb594ca.js');
...
const Datetime = class {
  ...
  renderFooter() {
    ...
    return (index.h("div", { class: "datetime-footer" }, index.h("div", { class: "datetime-buttons" }, index.h("div", { class: {
      ...
      } }, index.h("slot", { name: "buttons" }, index.h("ion-buttons", null, index.h("ion-button", { color: this.color, onClick: () => this.cancel(true) }, this.cancelText), index.h("div", null, this.showClearButton && index.h("ion-button", { color: this.color, onClick: () => clearButtonClick() }, this.clearText), index.h("ion-button", { color: this.color, onClick: () => this.confirm(true) }, this.doneText))))))));
  }
  renderYearView() {
