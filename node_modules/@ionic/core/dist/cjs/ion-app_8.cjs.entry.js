...
const index = require('./index-3f167521.js');
const ionicGlobal = require('./ionic-global-729aef21.js');
const theme = require('./theme-30b7a575.js');
const helpers = require('./helpers-27851897.js');
const cubicBezier = require('./cubic-bezier-0b2ccc35.js');
const frameworkDelegate = require('./framework-delegate-d16d80d8.js');
const index$1 = require('./index-9d5269be.js');
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!ionicGlobal.config.getBoolean('_testing')) {
          Promise.resolve().then(function () { return require('./tap-click-d9f17696.js'); }).then(module => module.startTapClick(ionicGlobal.config));
        }
        if (ionicGlobal.config.getBoolean('statusTap', isHybrid)) {
          Promise.resolve().then(function () { return require('./status-tap-faecbf15.js'); }).then(module => module.startStatusTap());
        }
        if (ionicGlobal.config.getBoolean('inputShims', needInputShims())) {
          Promise.resolve().then(function () { return require('./input-shims-2078f372.js'); }).then(module => module.startInputShims(ionicGlobal.config));
        }
        ...
        Promise.resolve().then(function () { return require('./focus-visible-13950869.js'); }).then(module => this.focusVisible = module.startFocusVisible());
      });
    }
  }
  /**
...
const RouterOutlet = class {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await Promise.resolve().then(function () { return require('./swipe-back-07cc57ed.js'); })).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
      if (this.ani) {
        this.ani.onFinish(() => {
          this.gestureOrAnimationInProgress = false;
          if (this.swipeHandler) {
