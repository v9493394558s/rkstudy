...
const PickerInternal = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    attachShadow(this);
...
const IonPickerInternal = /*@__PURE__*/proxyCustomElement(PickerInternal, [33,"ion-picker-internal"]);

export { IonPickerInternal };
