(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var IonTabs = /** @class */ (function () {
        ...
        __decorate([
            core.HostListener('ionTabButtonClick', ['$event'])
    ...
    var IonModal = /** @class */ (function () {
        ...
        IonModal = __decorate([
            ...
            core.Component({ selector: "ion-modal", changeDetection: core.ChangeDetectionStrategy.OnPush, template: "<ng-container [ngTemplateOutlet]=\"template\" *ngIf=\"isCmpOpen\"></ng-container>", inputs: ["animated", "backdropBreakpoint", "backdropDismiss", "breakpoints", "cssClass", "enterAnimation", "event", "handle", "initialBreakpoint", "isOpen", "keyboardClose", "leaveAnimation", "mode", "presentingElement", "showBackdrop", "swipeToClose", "translucent", "trigger"] })
        ], IonModal);
        return IonModal;
    }());
    ...
    var IonPopover = /** @class */ (function () {
        ...
        IonPopover = __decorate([
            ...
            core.Component({ selector: "ion-popover", changeDetection: core.ChangeDetectionStrategy.OnPush, template: "<ng-container [ngTemplateOutlet]=\"template\" *ngIf=\"isCmpOpen\"></ng-container>", inputs: ["alignment", "animated", "arrow", "backdropDismiss", "cssClass", "dismissOnSelect", "enterAnimation", "event", "isOpen", "keyboardClose", "leaveAnimation", "mode", "showBackdrop", "translucent", "trigger", "triggerAction", "reference", "size"] })
        ], IonPopover);
        return IonPopover;
    }());
    ...
    var appInitialize = function (config, doc, zone) {
        return function () {
            ...
            if (win && typeof window !== 'undefined') {
                core$1.setupConfig(__assign({}, config, { _zoneGate: function (h) { return zone.run(h); } }));
    ...
    Object.defineProperty(exports, 'getTimeGivenProgression', {
        enumerable: true,
        get: function () {
            return core$1.getTimeGivenProgression;
        }
    });
